...
if (typeof window.web3 !== 'undefined' && typeof window.web3.currentProvider !== 'undefined') {
  ...
  //@todo - how do we support test and main net if here?
   var eth = new Eth(new Eth.HttpProvider("https://ropsten.infura.io/v3/1056128fdc564b4baf81402442e584dd"));
...
//     contract_address = "0x2BF91c18Cd4AE9C2f2858ef9FE518180F7B5096D";
     network = "Still not present on MainNet - Please switch to Ropsten";
     break
   case "2":
   ...
   case "3":
     ...
     contract_address = "0xAAB2bc79cCdfBB6997a7D2B8CAc5673141CE43b5";
     break
   case "4":
 ...
 eth.coinbase().then((result) => {
   ...
   //display PLUTO account owned by connected account
   token.balanceOf(result).then((balance) => {
   el_safe('#PLUTOCount').innerHTML = (balance.balance / 1000000000000000000).toString(10);
   });
...
function updateStatsThatHaveDependencies(stats) {
  ...
  el_safe('#SupplyRemaininginEra').innerHTML = "<b>" + supply_remaining_in_era.toLocaleString() + "</b> PLUTO <span style='font-size:0.8em;'>(" + rewards_blocks_remaining_in_era + " blocks)</span>";
...
// WARNING !!!
//
// THIS MUST BE MODIFIED WHEN DEALING WITH MAINNET 
//
//
...
//    var address_url = 'https://etherscan.io/address/' + address;
    var address_url = 'https://ropsten.etherscan.io/address/' + address;
  }
...
function updateAllMinerInfo(eth, stats, hours_into_past){
  ...
  var known_miners = {
// added oldminer address
    "0x80Cd30b6C4B7a97058E260e45DAD194651887FE1" : [ "OldMiner", "https://cryptocosmos.github.io", pool_colors.blue]
...
//    topics: ['0xcf6fbb9dcea7d07263ab4f5c3a92f53af33dffc421d9d121e1c74b307e68189d', null],
    address: '0xAAB2bc79cCdfBB6997a7D2B8CAc5673141CE43b5',
    topics: ['0xbe586b41fd68511fceb23f91f523808777101d151ae0001bca926373d214de9e', null],
// TO BE RECHECKED HERE ABOVE
  })
  .then((result) => {
...
//      var transaction_url = 'https://etherscan.io/tx/' + tx_hash;
 //     var block_url = 'https://etherscan.io/block/' + eth_block;
	  ...
	  var transaction_url = 'https://ropsten.etherscan.io/tx/' + tx_hash;
      var block_url = 'https://ropsten.etherscan.io/block/' + eth_block;
