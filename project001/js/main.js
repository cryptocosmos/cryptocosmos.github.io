...
const _CONTRACT_ADDRESS = "0xAAB2bc79cCdfBB6997a7D2B8CAc5673141CE43b5";
...
/* get last hours_into_past worth of mined PLUTO blocks, save to a CSV file */
function getMinerInfoCSV(eth, stats, hours_into_past){
  ...
  .then((result) => {
    ...
    // Start file download.
    downloadTextAsFile("PLUTO-blocks-" + date_now.toLocaleTimeString() + ".csv",
                       csv_text);
